       ...
       // public NEVector4 Rotation { get { return m_Rotation; } /*set { m_Rotation = value; m_Rotation.W = 0.0f; }*/ }
            ...
            float scaleX, float scaleY, float scaleZ)
        {
           ...
           // m_Rotation = new NEVector4(rotationX, rotationY, rotationZ, 0.0f);
            ...
            RotationMat = NEMatrix4x4.CreateRotationX(rotationX) * NEMatrix4x4.CreateRotationY(rotationY) * NEMatrix4x4.CreateRotationZ(rotationZ); 
        }
        ...
        {
            RotationMat = RotationMat * NEMatrix4x4.CreateRotationX(thetaRad);
        }

        public void RotateY(float thetaRad)
        {
            RotationMat = RotationMat * NEMatrix4x4.CreateRotationY(thetaRad);
        ...
        {
            RotationMat = RotationMat * NEMatrix4x4.CreateRotationZ(thetaRad);
        }
        ...
        public void SetRotation(float x, float y, float z)
        {
            ...
            //m_Rotation.Y = y;
            //m_Rotation.Z = z;
            RotationMat = NEMatrix4x4.CreateRotationX(x) * 
                NEMatrix4x4.CreateRotationY(y) * NEMatrix4x4.CreateRotationZ(z);
        }
